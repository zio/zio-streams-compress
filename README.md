...
```sbt
libraryDependencies += "dev.zio" %% "zio-streams-compress-brotli" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-brotli4j" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-bzip2" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-gzip" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-lz4" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-snappy" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-tar" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-zip" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-zip4j" % "1.1.0"
libraryDependencies += "dev.zio" %% "zio-streams-compress-zstd" % "1.1.0"
```
...
//> using dep dev.zio:zio-streams-compress-gzip:1.1.0
//> using dep dev.zio:zio-streams-compress-tar:1.1.0
//> using dep dev.zio:zio-streams-compress-zip4j:1.1.0
